<?php
	$Auth->allow("upload_fichier_admin");
...
<?php
	...
	if(!empty($_POST))
	{
		...
		{
			echo "Sorry, only MS Excel, MS Word, JPG, JPEG, PNG & PDF files are allowed.<br>";
			$uploadOk = 0;
		}
...
<!--  form -->
 ...
 <!-- Liste -->
	...
	<table>
		...
		<tbody>
			<form action="/admin/upload_fichier_admin" method="post" enctype="multipart/form-data">
				<tr>
